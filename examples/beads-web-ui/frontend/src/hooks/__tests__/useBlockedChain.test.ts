...
describe('computeAllBlockedCounts', () => {
  ...
  it('computes counts for diamond pattern', () => {
    const counts = computeAllBlockedCounts(['D', 'E', 'F', 'G'], diamondEdges);
...
describe('useBlockedChain', () => {
  describe('getChain', () => {
    it('returns correct result for simple chain', () => {
      const { result } = renderHook(() => useBlockedChain({ edges: simpleChainEdges }));
    ...
    it('returns correct result for diamond pattern', () => {
      const { result } = renderHook(() => useBlockedChain({ edges: diamondEdges }));
  ...
  describe('circular dependencies', () => {
    it('does not infinite loop in getChain', () => {
      const { result } = renderHook(() => useBlockedChain({ edges: circularEdges }));
  ...
  describe('memoization and stability', () => {
    it('getChain function is stable across re-renders', () => {
      const { result, rerender } = renderHook(() => useBlockedChain({ edges: simpleChainEdges }));
    ...
    it('functions update when edges change', () => {
      const { result, rerender } = renderHook(({ edges }) => useBlockedChain({ edges }), {
  ...
  describe('real-world scenarios', () => {
    it('handles deep chain (depth limit test)', () => {
      ...
      const { result } = renderHook(() => useBlockedChain({ edges: deepEdges }));
    ...
    it('handles multiple disconnected subgraphs', () => {
      ...
      const { result } = renderHook(() => useBlockedChain({ edges: disconnectedEdges }));
