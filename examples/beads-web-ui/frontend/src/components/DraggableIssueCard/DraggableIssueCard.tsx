...
/**
 * Drag handle icon - 6 grip dots in 2x3 grid pattern.
 * Only used internally by DraggableIssueCard.
 */
function DragHandleIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg
      className={className}
      width="12"
